...
SELECT Fname [First name], Lname [Last name], Salary, Dno [Department Number] FROM Employee;

--3.Display all the projects names, locations and the department which is responsible about it.

SELECT Pname [Project Name], Plocation [Location], Dnum [Department] FROM Project;
...
SELECT Fname + ' ' + Lname [Full Name],
	Salary, (Salary *10 ) / 100 [Commission], (Salary + ((Salary*10) / 100))
...
SELECT Pname,Pname,Plocation FROM Project;